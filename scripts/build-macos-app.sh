...
cd "${ROOT_DIR}"
CGO_ENABLED=0 GOOS=darwin GOARCH="${TARGET_ARCH}" go build -ldflags="-s -w" -o "${MACOS_DIR}/crossover" ./cmd/crossover

echo "==> Gerando PkgInfo..."
echo -n "APPL????" > "${CONTENTS_DIR}/PkgInfo"

echo "==> Copiando ícones..."
cp "${ROOT_DIR}/assets/crossover.png" "${RESOURCES_DIR}/AppIcon.png"
cp "${ROOT_DIR}/assets/crossover.svg" "${RESOURCES_DIR}/AppIcon.svg"
...
echo "==> Bundle Crossover.app criado com sucesso em: ${APP_DIR}"
