...
The system SHALL / O binário do Crossover DEVE permitir iniciar e inspecionar o daemon em segundo plano através de comandos de terminal.

#### Scenario: Início do daemon
- **WHEN** o usuário executa o comando `crossover daemon`
...
- **WHEN** o usuário executa o comando `crossover status`
...
- **WHEN** o usuário executa o comando `crossover devices`
...
- **WHEN** o usuário executa `crossover pair <device-name-or-id>`
...
- **WHEN** o usuário executa `crossover send <caminho-arquivo> <dispositivo>`
